...
module.exports = {
    ...
    execute : async (client, message, args) => {
        ...
        let embed = new MessageEmbed().setAuthor(message.member.displayName, message.author.avatarURL({dynamic: true})).setFooter("Wasley was here?").setColor("RANDOM").setTimestamp();
