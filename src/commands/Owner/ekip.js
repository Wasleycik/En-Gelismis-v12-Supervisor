...
module.exports = {
    ...
    let embed = new Discord.MessageEmbed().setColor("RANDOM").setFooter(config.bot.footer, message.author.avatarURL({dynamic: true})).setTimestamp().setAuthor(message.guild.name, message.guild.iconURL({dynamic: true}))
    ...
    **${ekipler.EkipAdı}** ekibinin bilgileri gösteriliyor!
    ...
    \`Katılım Tarihi:\` \`${new Date(ekipler.KatılmaTarihi).toTurkishFormatDate()}\`
